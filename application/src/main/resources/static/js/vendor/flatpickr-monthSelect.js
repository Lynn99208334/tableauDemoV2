        ...
        return function (fp) {
            ...
            function bindEvents() {
                fp._bind(fp.prevMonthNav, "click", function (e) {
                    ...
                    fp.changeYear(fp.currentYear - 1); selectYear(); buildMonths();
                });
            ...
            function setMonth(date) {
                ...
                switch (fp.config.mode) {
                    case "single": selectedDates = [selectedDate]; break;
                    case "multiple": selectedDates.push(selectedDate); break;
                    case "range":
            ...
            var shifts = { 37: -1, 39: 1, 40: 3, 38: -3 };
            ...
            function closeHook() {
                if (fp.config && fp.config.mode === "range" && fp.selectedDates.length === 1) fp.clear(false);
            ...
            return {
                onParseConfig: function () { fp.config.enableTime = false; },
                onValueUpdate: setCurrentlySelected,
                onKeyDown: onKeyDown,
                onReady: [
                    stubCurrentMonth, clearUnnecessaryDOMElements, build, bindEvents, setCurrentlySelected,
                    function () { fp.config.onClose.push(closeHook); fp.loadedPlugins.push("monthSelect"); },
                ],
                onDestroy: [
                    unstubCurrentMonth, destroyPluginInstance,
                    function () { fp.config.onClose = fp.config.onClose.filter(function (hook) { return hook !== closeHook; }); },
                ],
            };
        };
    }
